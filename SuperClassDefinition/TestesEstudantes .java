...
// boolean candidato = true;//ainda pode ser candidato?? ao longo das selecoes
// esse boolean pode se tornar false

// //primeira etapa da seleção
// void selecao1(EstudanteGraduacao estudante) {
// // if(estudante.semestre == 1){//não pode estar no primeiro semestre
// // System.out.println("nao podem participar da selecao alunos do primeiro
// semestre");
// // candidato = false;
// // }
// /* else if(estudante.reprovacao == "s"){//não pode ter reprovado em qualquer
// disciplina
// System.out.println("Desclassificado");
// candidato = false;
// }
// */
// // else if(estudante.status == false){//nÃ£o pode estar inativo
// // System.out.println("Desclassificado");
// // candidato = false;
// // }
// // else if(estudante.nota_da_disciplina < 7){// nÃ£o pode ter ficado na af da
// diciplina que concorre
// // System.out.println("Desclassificado");
// // candidato = false;
// // }
// }
...
// for(int i=0; i<8; i++) {
// if(estudante.nota_da_disciplina < notas[i]) {//se um concorrente tiver nota
...
// if(estudante.ide < ides[i]) {//se um concorrente tiver ide maior que o
// candidato
// System.out.println("Nao foi selecionado(a)");
// break;
// }
// }
// else if(i==7) {// se no final nÃ£o ouve alguem melhor que o candidato
